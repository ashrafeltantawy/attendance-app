...
st.markdown(
    ...
    <div class="app-header">
        ...
        <div class="cta-box">
            <span  class="header-cta">سجل حضورك مع أكاديمية ادراك للإعلام</span>
        </div>
    </div>
    """,
...
# -----------------------------------------------------
st.set_page_config(
    page_title="سجل حضورك مع اكاديمية ادراك للإعلام",
    page_icon="📝",
    layout="centered"
)
...
MASTERCLASS_SCHEDULE = {
    ...
    "قعدة كوميديا - صالح النواوي وبوش في ضيافة سارة الرفاعي": "الثلاثاء 9 ديسمبر، 03:00 عصراً",
        "كيف تميز الحقيقة من التضليل في زمن الذكاء الاصطناعي - معاذ الطاهر": "الأربعاء 9 ديسمبر، 11:30 صباحاً",
    "صناعة المحتوى التراثي – يوسف بالحمر ومحمد البلوشي وهزاع الشرياني": "الأربعاء 9 ديسمبر، 03:00 مساءاً",
    "كيف تعمل فلوس من السوشيال ميديا – محمد أوكا وسارة الرفاعي": "الأربعاء 9 ديسمبر، 02:00 ظهراً",
