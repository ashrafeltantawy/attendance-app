...
MASTERCLASS_SCHEDULE = {
    "مهارات Ai لا يمكنك تجاهلها - فهمي متولي": "الإثنين 8 ديسمبر، 11:30 صباحاً",
    "تصميم العلامة التجارية في عصر الـAi - حذيفة تاج السر": "الإثنين 8 ديسمبر، 02:00 ظهراً",
...
MASTERCLASS_SHORT_NAMES = {
    "مهارات Ai لا يمكنك تجاهلها - فهمي متولي": "الذكاء الاصطناعي",
    "تصميم العلامة التجارية في عصر الـAi - حذيفة تاج السر": "العلامات التجارية",
